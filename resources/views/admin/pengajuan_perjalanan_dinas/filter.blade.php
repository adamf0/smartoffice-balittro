...
<script>
    function filter(){
        ...
        if(filter == "nama"){
            window.location.href = "{{ url('/admin/cetak/pengajuan_perjalanan_dinas/') }}/"+filter+"/"+nama;
        }
        else if(filter == "tujuan"){
            window.location.href = "{{ url('/admin/cetak/pengajuan_perjalanan_dinas/') }}/"+filter+"/"+tujuan;
        }
        else if(filter == "tanggal"){
            window.location.href = "{{ url('/admin/cetak/pengajuan_perjalanan_dinas/') }}/"+filter+"/"+tanggal;
        }
    }
    function run() {
