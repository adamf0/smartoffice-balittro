...
<script>
    function filter(){
        ...
        if(filter == "nama"){
            window.location.href = "{{ url('/admin/cetak/pinjam_kendaraan/') }}/"+filter+"/"+nama;
        }
        else if(filter == "tujuan"){
            window.location.href = "{{ url('/admin/cetak/pinjam_kendaraan/') }}/"+filter+"/"+tujuan;
        }
        else if(filter == "tanggal"){
            window.location.href = "{{ url('/admin/cetak/pinjam_kendaraan/') }}/"+filter+"/"+tanggal;
        }
    }
    function run() {
