<div class="row">
    ...
    <div class="col-12">
        <div class="card">
            ...
            <div class="card-body">
            	<div class="col-12">
            		<a href='{{ url("/super_admin/jenis_jabatan/add") }}' class="btn btn-info">Tambah Data</a>
            	</div>
	            <div class="col-12">
		                	...
		                	<tr>
			                	...
			                	<td>
									@php $id = $data['id'] @endphp
				               		<a href='{{ url("/super_admin/jenis_jabatan/delete/".$id) }}' class="btn btn-danger">Hapus</a>
				               		<a href='{{ url("/super_admin/jenis_jabatan/edit/".$id) }}' class="btn btn-warning">Ubah</a>
				               	</td>
				            </tr>
		               		@php $i++ @endphp
		               	@endforeach
